...
print("modelhigh:::",modelhigh)
print("modellow:::",modellow)

print("NOTE:For StatisticalArbitrage opportunities to exist the lowest value should be at an earlier date than the highest value ")

print("............Results of Statistical Arbitrage.........")
print("The Maximum  prediction of 2017 data is::",max_high)
print("The Minimum  prediction of 2017 data is::",min_low)
print("The Actual high value according to the date of the prediction is::",actual_high)
print("The Actual low value according to the date of the prediction is::",actual_low)

print("......Model Summary.......")
print(".....Modelhigh accuracy.... ")
print(accuracyhigh)
print(".....Modellow accuracy.... ")
print(accuracylow)
